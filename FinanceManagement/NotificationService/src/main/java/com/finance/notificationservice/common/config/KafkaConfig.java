package com.finance.notificationservice.common.config;
...
public class KafkaConfig {
    ...
    public static final String USER_EVENTS_TOPIC = "user-events"; //for general user events
    public static final String USER_NOTIFICATION_TOPIC = "user-notification"; // for notification bell socket
